...
IMAGES = {
    ...
    "use": "images/use.jpg",
    "question": "images/start.jpg",
    "garant": "images/start.jpg",
...
# Вспомогательная функция для изменения изображения, подписи и клавиатуры
...
async def description_callback(query: types.CallbackQuery):
    ...
    await edit_message_with_image(query, text, IMAGES["description"], keyboard)
...
async def use_callback(query: types.CallbackQuery):
    ...
    🧖♀️ Шаг 1: Подготовьте кожу
    Очистите кожу, нанесите крем, сыворотку, гель или другую подходящую уходовую косметику.

    📊 Шаг 2: Выберите режим
    Согласно таблице ниже выберите длительность и периодичность процедур.

    ⚡ Шаг 3: Включите аппарат
    Включите аппарат и выберите нужный режим.

    ➡️ Шаг 4: Проведите массаж
    Водите массажную головку по массажным линиям от центра к периферии.

    🧹 Шаг 5: Завершите процедуру
    Салфеткой удалите излишки косметического средства.
    """
